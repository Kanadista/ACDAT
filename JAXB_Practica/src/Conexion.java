...
public class Conexion {
    ...
    private String sourceURL = "jdbc:sqlserver://localhost;databaseName=Apuestas;user=prueba;password=prueba123;";
    ...
    public Conexion(){
        ...
        try{
            conexionBaseDatos = (DriverManager.getConnection(sourceURL));
